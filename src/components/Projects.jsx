...
export function Projects(){
    ...
    <div className="row">
      ...
      <div style={{
         ...
         <div className=" col-xl-4 offset-xl-2 pbox col-12 mt-3 mb-5">
         <div className=" bord">
