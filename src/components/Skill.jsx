    ...
    return <div id="skills" className="skills" >
        <div  className="container-fluid ">
            ...
            <div  className="row  mb-5 f1 pt-3 pb-3">
                ...
                <div className="col-xl-2 col-md-6 "><img className="logo w-50  img-fluid" src="https://img.icons8.com/color/480/000000/react-native.png" alt=""/></div>
                <div className="col-xl-2 col-md-6 offset-xl-3 mt-5"><img className=" logo w-50 img-fluid" src="https://i.ibb.co/zx0Tt9M/bootstrap.png" alt=""/></div>
                <div className="col-xl-2 col-md-6 mt-5"><img className="logo w-50 img-fluid" src="https://img.icons8.com/fluent/480/000000/github.png" alt=""/></div>
                <div className="col-xl-2 col-md-6 mt-5 offset-md-3 offset-xl-0"><img className="logo w-50  img-fluid" src="https://img.icons8.com/color/480/000000/npm.png" alt=""/></div>
            </div>
        ...
        <div className="front  "><h2>Back End Tools</h2></div> 
            <div className="row f1 pt-3 pb-3 mt-2 mb-5">
                ...
                <div className="col-xl-2 "><img className="logo w-50 img-fluid" src="https://i.ibb.co/9smDM6j/pngegg.png" alt=""/></div>
